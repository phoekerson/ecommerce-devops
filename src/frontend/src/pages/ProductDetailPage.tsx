...
const ProductDetailPage = () => {
  ...
  return (
    <article className="rounded-xl bg-white p-4 shadow-sm md:p-6">
      <button
        onClick={() => navigate(-1)}
        className="mb-4 rounded-md border border-slate-200 px-3 py-1.5 text-sm text-slate-600 hover:bg-slate-100"
      >
        Retour
      </button>
      ...
      />
      <div>
        <span className="mb-3 inline-block rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold uppercase text-indigo-700">
          {product.category}
        </span>
        ...
        <div className="mb-4 inline-flex items-center overflow-hidden rounded-lg border border-slate-300">
          <button
